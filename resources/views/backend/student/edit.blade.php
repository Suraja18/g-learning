                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="roleId">
                                                @forelse ($role as $r)
                                                    <option value="{{ $r->id }}"
                                                        {{ old('roleId', $student->role_id) == $r->id ? 'selected' : '' }}>
                                                        {{ $r->name }}</option>
                                                @empty
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="gender">
                                                <option value="male" @if (old('gender', $student->gender) == 'male') selected @endif>
                                                    Male
                                                </option>
                                                <option value="female" @if (old('gender', $student->gender) == 'female') selected @endif>
                                                    Fenale
                                                </option>
                                                <option value="other" @if (old('gender', $student->gender) == 'other') selected @endif>
                                                    Other
                                                </option>
                                            </select>
                                        </div>
