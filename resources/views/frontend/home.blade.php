...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-7 mb-lg-0 order-2 order-lg-0 d-flex align-items-center">
                    <div class="banner-two-start">
                        ...
                        <p>
                            Our commitment is to guide you to the finest online courses, offering expert insights whenever
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <a href="{{ route('searchCourse') }}" class="button button-lg button--primary mt-5">Browse all
                        Courses</a>
                </div>
            </div>
        </div>
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="contentCard contentCard--course">
                                        <div class="contentCard-top">
                                            <a href="#"><img src="{{ asset('uploads/courses/' . $pc->image) }}"
                        ...
                        <div class="row">
                            @forelse ($designCourses as $dc)
                                <div class="col-xl-4 col-md-6">
                                    <div class="contentCard contentCard--course">
                                        <div class="contentCard-top">
                                            <a href="#"><img src="{{ asset('uploads/courses/' . $dc->image) }}"
                                                    alt="images" class="img-fluid" /></a>
                                        </div>
                                        <div class="contentCard-bottom">
                                            <h5>
                        ...
                        <div class="row">
                            @forelse ($developmentCourses as $dv)
                                <div class="col-xl-4 col-md-6">
                                    <div class="contentCard contentCard--course">
                                        <div class="contentCard-top">
                                            <a href="#"><img src="{{ asset('uploads/courses/' . $dv->image) }}"
                                                    alt="images" class="img-fluid" /></a>
                                        </div>
                                        <div class="contentCard-bottom">
                                            <h5>
                        ...
                        <div class="row">
                            @forelse ($businessCourses as $bc)
                                <div class="col-xl-4 col-md-6">
                                    <div class="contentCard contentCard--course">
                                        <div class="contentCard-top">
                                            <a href="#"><img src="{{ asset('uploads/courses/' . $bc->image) }}"
                                                    alt="images" class="img-fluid" /></a>
                                        </div>
                                        <div class="contentCard-bottom">
                                            <h5>
                        ...
                        <div class="row">
                            @forelse ($itCourses as $ic)
                                <div class="col-xl-4 col-md-6">
                                    <div class="contentCard contentCard--course">
                                        <div class="contentCard-top">
                                            <a href="#"><img src="{{ asset('uploads/courses/' . $ic->image) }}"
                                                    alt="images" class="img-fluid" /></a>
                                        </div>
                                        <div class="contentCard-bottom">
                                            <h5>
    ...
    <section class="section feature section section--bg-offwhite-one">
        <div class="container">
            <h2 class="font-title--md text-center">Why You'll Learn with G-Learning</h2>
            <div class="row">
                        ...
                        <div class="cardFeature__icon cardFeature__icon--bg-r">
                            <svg width="27" height="27" viewBox="0 0 27 27" fill="none"
                                ...
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    stroke="currentColor" stroke-width="2.5" stroke-linecap="round"
                                    stroke-linejoin="round" />
                                <path d="M17.7021 17.0667L12.8113 14.1491V7.86108" stroke="currentColor"
                ...
                <div class="col-lg-6 order-2 order-lg-0">
                    <div class="learning-rules-starts">
                        <h2 class="font-title--md">
                            G-learning Simple <br class="d-none d-md-block" />
                            Learning Steps
                        </h2>
    ...
    <section class="section section--bg-offwhite-three latest-events-featured main-events-featured">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <a href="{{ route('searchCourse') }}" class="button button-lg button--primary mt-lg-5 mt-5">Browse
                        all
                        events</a>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="main-become-instructor-item ms-12 mb-0">
                        ...
                        <div class="main-text">
                            <h6 class="font-title--sm">Use G-learning For Business</h6>
                            <p>
                                Praesent ultricies nulla ac congue bibendum. Aliquam tempor euismod purus posuere
                                gravida. Praesent augue sapien, vulputate eu imperdiet eget, tempor at enim.
                            </p>
                            <div class="text-center">
                                <a href="#" class="green-btn">Get G-learning For Business</a>
                            </div>
                        </div>
                    </div>
                </div>
