                            ...
                            <div class="cart">
                                                    ...
                                                    <div class="productContent-item__info productContent-item">
                                                        ...
                                                        <div class="price">
                                                            <h6 class="font-para--md">
                                                                {{ $details['price'] ? 'NPR' . $details['price'] : 'Free' }}
                                                            </h6>
                                                            <p><del>{{ $details['old_price'] ? 'NPR' . $details['old_price'] : '' }}</del>
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="cart__checkout-process">
                                    <ul>
                                        <li>
                                            <p>Subtotal</p>
                                            <p>{{ 'NPR' . number_format((float) session('cart_details')['cart_total'], 2) }}
                                            </p>
                                            {{-- {{ 'NPR' . (session('cart_details') && array_key_exists('cart_total',
                                    ...
                                    '0.00') }} --}}
                                        ...
                                        <li>
                                            <p>Taxes (15%)</p>
                                            <p>{{ 'NPR' . number_format((float) session('cart_details')['tax'], 2) }}</p>
                                            {{-- {{ 'NPR' . (session('cart_details') && array_key_exists('tax',
                                    ...
                                    '0.00') }} --}}
                                        ...
                                        <li>
                                            ...
                                            <p class="total-price font-title--card">
                                                {{ 'NPR' . number_format((float) session('cart_details')['total_amount'], 2) }}
                                            </p>
                                            {{-- {{ 'NPR' . (session('cart_details') && array_key_exists('total_amount',
