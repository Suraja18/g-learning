                                    ...
                                    <div class="text">
                                        ...
                                        <div class="bottom-wizard d-flex justify-content-between align-items-center">
                                            <p>
                                                ...
                                                <span><del>{{ $details['old_price'] ? 'NPR' . $details['old_price'] : '' }}</del></span>
                                            </p>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="summery-wizard">
                            <div class="summery-wizard-text pt-0">
                                <h6>Subtotal</h6>
                                <p> {{ 'NPR' . number_format((float) session('cart_details')['cart_total'], 2) }}</p>
                            </div>
                            <div class="summery-wizard-text">
                                <h6>Coupon Discount ({{ session('cart_details')['discount'] ?? 0.0 }}%)</h6>
                                <p>{{ 'NPR' . number_format((float) isset(session('cart_details')['discount_amount']) ? session('cart_details')['discount_amount'] : 0.0, 2) }}
                                </p>
                            </div>
                            <div class="summery-wizard-text">
                                <h6>Taxes (15%)</h6>
                            ...
                            <div class="total-wizard">
                                ...
                                <p class="font-title--card">
                                    {{ 'NPR' . number_format((float) session('cart_details')['total_amount'], 2) }}</p>
                            </div>
